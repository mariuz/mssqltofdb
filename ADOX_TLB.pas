...
// File generated on 8/17/2000 11:59:12 AM from Type Library described below.
...
{$ENDIF}
  ...
  public
    ...
    procedure Disconnect; override;
    function  GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum): RightsEnum; overload;
    function  GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; ObjectTypeId: OleVariant): RightsEnum; overload;
    procedure SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; Action: ActionEnum; 
                             Rights: RightsEnum; Inherit: InheritTypeEnum); overload;
    procedure SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; Action: ActionEnum; 
                             Rights: RightsEnum; Inherit: InheritTypeEnum; ObjectTypeId: OleVariant); overload;
...
{$ENDIF}
  ...
  public
    ...
    procedure SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; Action: ActionEnum; 
                             Rights: RightsEnum; Inherit: InheritTypeEnum; ObjectTypeId: OleVariant); overload;
    procedure ChangePassword(const OldPassword: WideString; const NewPassord: WideString);
...
const
  CServerData: TServerData = (
    ...
    IntfIID:   '{00000616-0000-0010-8000-00AA006D2EA4}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
function  TADOXGroup.Get_Name: WideString;
begin
  Result := DefaultInterface.Get_Name;
end;

procedure TADOXGroup.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Set_Name(pVal);
end;

function  TADOXGroup.Get_Users: Users;
begin
  Result := DefaultInterface.Get_Users;
end;

function  TADOXGroup.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, EmptyParam);
end;

function  TADOXGroup.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                                    ObjectTypeId: OleVariant): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, ObjectTypeId);
end;

procedure TADOXGroup.SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                                    Action: ActionEnum; Rights: RightsEnum; Inherit: InheritTypeEnum);
begin
  DefaultInterface.SetPermissions(Name, ObjectType, Action, Rights, Inherit, EmptyParam);
end;

procedure TADOXGroup.SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                                    Action: ActionEnum; Rights: RightsEnum; 
                                    Inherit: InheritTypeEnum; ObjectTypeId: OleVariant);
begin
  DefaultInterface.SetPermissions(Name, ObjectType, Action, Rights, Inherit, ObjectTypeId);
end;
...
function  TADOXGroupProperties.Get_Name: WideString;
begin
  Result := DefaultInterface.Get_Name;
end;

procedure TADOXGroupProperties.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Set_Name(pVal);
end;

function  TADOXGroupProperties.Get_Users: Users;
begin
  Result := DefaultInterface.Get_Users;
end;
...
const
  CServerData: TServerData = (
    ...
    IntfIID:   '{00000619-0000-0010-8000-00AA006D2EA4}';
    EventIID:  '';
    LicenseKey: nil;
    Version: 500);
begin
...
function  TADOXUser.Get_Name: WideString;
begin
  Result := DefaultInterface.Get_Name;
end;

procedure TADOXUser.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Set_Name(pVal);
end;

function  TADOXUser.Get_Groups: Groups;
begin
  Result := DefaultInterface.Get_Groups;
end;

function  TADOXUser.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, EmptyParam);
end;

function  TADOXUser.GetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                                   ObjectTypeId: OleVariant): RightsEnum;
begin
  Result := DefaultInterface.GetPermissions(Name, ObjectType, ObjectTypeId);
end;

procedure TADOXUser.SetPermissions(Name: OleVariant; ObjectType: ObjectTypeEnum; 
                                   Action: ActionEnum; Rights: RightsEnum; Inherit: InheritTypeEnum);
begin
  DefaultInterface.SetPermissions(Name, ObjectType, Action, Rights, Inherit, EmptyParam);
end;
...
procedure TADOXUser.ChangePassword(const OldPassword: WideString; const NewPassord: WideString);
begin
  DefaultInterface.ChangePassword(OldPassword, NewPassord);
end;
...
function  TADOXUserProperties.Get_Name: WideString;
begin
  Result := DefaultInterface.Get_Name;
end;

procedure TADOXUserProperties.Set_Name(const pVal: WideString);
begin
  DefaultInterface.Set_Name(pVal);
end;

function  TADOXUserProperties.Get_Groups: Groups;
begin
  Result := DefaultInterface.Get_Groups;
end;
...
procedure Register;
begin
  RegisterComponents('ActiveX',[TADOXTable, TADOXColumn, TADOXIndex, TADOXKey, 
